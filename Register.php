                    ...
                    <div class="panel-body">
                        <form action="#" name="form1" method="post">
                            ...
                            <div class="alert alert-danger" id="failure" style="margin-top:15px;  display: none">
                                <strong>Already Exist!</strong> This User is Already Exist.
                            </div>
                        </form>
                    </div>
                </div>
...
<?php
  ...
  if(isset($_POST['submit1'])){
    ...
    if($count > 0){
        ...
        mysqli_query($conn , "insert into registration values('NULL','$_POST[firstname]','$_POST[lastname]','$_POST[username]','$_POST[password]','$_POST[email]','$_POST[phone]')") or die(mysqli_error($conn));
        ?>
        <script type = "text/javascript">
