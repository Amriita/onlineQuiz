                    ...
                    <div class="panel-body">
                        <form action="#" id="loginForm" name="form1" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" placeholder="username" title="Please enter you username" required="" value="" name="username" id="username" class="form-control">
                            ...
                            <div class="alert alert-danger" id="failure" style="margin-top:15px;  display: none">
                                <strong>Does Not Exist !</strong> Username and Password.
                            </div>
                        </form>
                    </div>
                </div>
